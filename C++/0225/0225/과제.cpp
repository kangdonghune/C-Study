...
void main()
{
	...
	cout << "" << endl;
	double dKorean =0, dEnglish = 0, dMath = 0, dAverage = 0, dTotal = 0;
	...
	dTotal = (dKorean + dEnglish + dMath);
	dAverage = dTotal / 3;
	cout << "평균 성적은" << dAverage << "점 입니다." << endl;
	cout << "총점은 " << dTotal << "점입니다." <<endl;
	cout << "" << endl;
	...
	cout << "선의 개수는 " << iLinecount << "개 입니다." << endl;
